			...
			<div class="col-md-8">
				...
				<div class="panel panel-info">
					...
					<div class="panel panel-body">
						<input type="text" class="form-control" name="" id="add_category" placeholder="Enter Category Name" required><p><br/></p>
						<input type="submit" class="btn btn-success" name="" id="btn_add_category" >
					</div>
